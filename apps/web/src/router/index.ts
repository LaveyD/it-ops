  ...
  routes: [
    ...
    // 后台管理：/admin 设 public，登录+viewer 拦截由 AdminLayout 内处理（避免守卫内异步 ensureMe）
    {
      ...
      children: [
        ...
        { path: 'assets/location', name: 'admin-location', component: () => import('../views/admin/Placeholder.vue'), meta: { title: '机房与区域' } },
        { path: 'assets/device', name: 'admin-device', component: () => import('../views/admin/Placeholder.vue'), meta: { title: '设备台账' } },
        { path: 'assets/biz', name: 'admin-biz', component: () => import('../views/admin/Placeholder.vue'), meta: { title: '业务系统' } },
        { path: 'alerts', name: 'admin-alerts', component: () => import('../views/admin/Placeholder.vue'), meta: { title: '告警中心' } },
