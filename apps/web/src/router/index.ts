  ...
  routes: [
    ...
    // 后台管理：/admin 设 public，登录+viewer 拦截由 AdminLayout 内处理（避免守卫内异步 ensureMe）
    {
      ...
      children: [
        ...
        { path: 'network/topology', name: 'admin-topology', component: () => import('../views/admin/TopologyView.vue'), meta: { title: '网络拓扑' } },
        { path: 'network/links', name: 'admin-links', component: () => import('../views/admin/LinksView.vue'), meta: { title: '链路视图' } },
        { path: 'network/topo3d', name: 'admin-topo3d', component: () => import('../views/admin/Topo3DView.vue'), meta: { title: '3D 拓扑预览' } },
        { path: 'twin', name: 'admin-twin', component: () => import('../views/admin/TwinView.vue'), meta: { title: '状态孪生' } },
        { path: 'twin/room', name: 'admin-twin-room', component: () => import('../views/admin/RoomView.vue'), meta: { title: '3D 机房' } },
        { path: 'system/users', name: 'admin-users', component: () => import('../views/admin/Users.vue'), meta: { title: '用户与角色' } },
        { path: 'system/audit', name: 'admin-audit', component: () => import('../views/admin/Audit.vue'), meta: { title: '审计日志' } },
        { path: 'system/notify', name: 'admin-notify', component: () => import('../views/admin/Notify.vue'), meta: { title: '通知配置' } },
      ],
    },
  ],
})
